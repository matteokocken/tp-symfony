 ...
 */
final class Version20220331124627 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pays (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(50) NOT NULL, nom VARCHAR(255) NOT NULL, code VARCHAR(2) DEFAULT NULL)');
